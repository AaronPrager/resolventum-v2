...
export function SubmitForm({ token }: { token: string }) {
  ...
  return (
    <form action={action} className="space-y-3" data-testid="submit-form">
      ...
      <Field label="PDF or photos (up to 10)" hint="On a phone you can take a photo of each page."><Input type="file" name="files" multiple accept="application/pdf,image/*" /></Field>
